...
- [x] T062 Ejecutar `python -m ruff format --check .`, `python -m ruff check .`, `python -m mypy machiavelli` y `python -m pytest`; exigir código 0 y cobertura global >=71%, sin omitir tests, relajar tipos ni bajar umbrales (depende de T061)
