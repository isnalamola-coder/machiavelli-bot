...
class Scenario:
    ...
    def is_defensible_city(self, city_type: str | None) -> bool:
        """Return whether the scenario enables the given defensible city type."""
        return city_type == "fortified" or (
            city_type == "fortress" and self.rules.fortress_active
        )
